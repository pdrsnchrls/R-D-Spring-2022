 ...
 * @generated
 */
public abstract class EnemyFinderBaseImpl extends BasePersistenceImpl<Enemy> {

	public EnemyFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return enemyPersistence.getBadColumnNames();
	}
