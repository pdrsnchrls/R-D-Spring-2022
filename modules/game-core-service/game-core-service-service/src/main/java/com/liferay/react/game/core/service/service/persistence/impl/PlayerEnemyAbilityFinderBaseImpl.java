 ...
 * @generated
 */
public abstract class PlayerEnemyAbilityFinderBaseImpl
	extends BasePersistenceImpl<PlayerEnemyAbility> {

	public PlayerEnemyAbilityFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return playerEnemyAbilityPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PlayerEnemyAbilityFinderBaseImpl.class);
