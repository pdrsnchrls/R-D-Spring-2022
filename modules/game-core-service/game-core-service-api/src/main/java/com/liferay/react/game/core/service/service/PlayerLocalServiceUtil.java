...
/**
 * Provides the local service utility for Player. This utility wraps
 * <code>com.liferay.react.game.core.service.service.impl.PlayerLocalServiceImpl</code> and
...
public class PlayerLocalServiceUtil {
	 ...
	 */
	public static Player deletePlayer(long playerId) throws PortalException {
		return getService().deletePlayer(playerId);
	}
	 ...
	 * @return the player that was removed
	 */
	public static Player deletePlayer(Player player) {
		return getService().deletePlayer(player);
	}
	...
	public static Player fetchPlayer(long playerId) {
		return getService().fetchPlayer(playerId);
	}
	 ...
	 * @throws PortalException if a player with the primary key could not be found
	 */
	public static Player getPlayer(long playerId) throws PortalException {
	 ...
	 */
	public static List<Player> getPlayers(int start, int end) {
	...
	private static volatile PlayerLocalService _service;
