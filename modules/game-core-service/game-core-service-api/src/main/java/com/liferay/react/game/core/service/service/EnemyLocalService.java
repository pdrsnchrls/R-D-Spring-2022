...
/**
 * Provides the local service interface for Enemy. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EnemyLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EnemyLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.react.game.core.service.service.impl.EnemyLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the enemy local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EnemyLocalServiceUtil} if injection and service tracking are not available.
	 */
