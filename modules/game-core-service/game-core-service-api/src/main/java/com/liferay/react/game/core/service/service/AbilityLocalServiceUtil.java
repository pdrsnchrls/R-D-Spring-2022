...
/**
 * Provides the local service utility for Ability. This utility wraps
 * <code>com.liferay.react.game.core.service.service.impl.AbilityLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AbilityLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.react.game.core.service.service.impl.AbilityLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Ability createAbility(long abilityId) {
		return getService().createAbility(abilityId);
	}
	 ...
	 */
	public static Ability deleteAbility(Ability ability) {
		return getService().deleteAbility(ability);
	}
	 ...
	 */
	public static Ability deleteAbility(long abilityId) throws PortalException {
		return getService().deleteAbility(abilityId);
	}
	...
	public static Ability fetchAbility(long abilityId) {
		return getService().fetchAbility(abilityId);
	}
	 ...
	 */
	public static List<Ability> getAbilities(int start, int end) {
		return getService().getAbilities(start, end);
	}
	 ...
	 */
	public static int getAbilitiesCount() {
		return getService().getAbilitiesCount();
	}
	 ...
	 * @throws PortalException if a ability with the primary key could not be found
	 */
	public static Ability getAbility(long abilityId) throws PortalException {
		return getService().getAbility(abilityId);
	}
	...
	public static Ability updateAbility(Ability ability) {
		return getService().updateAbility(ability);
	}

	public static AbilityLocalService getService() {
		return _service;
	}

	private static volatile AbilityLocalService _service;
