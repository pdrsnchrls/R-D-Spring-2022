...
/**
 * Provides the local service interface for Ability. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AbilityLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AbilityLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.react.game.core.service.service.impl.AbilityLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ability local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AbilityLocalServiceUtil} if injection and service tracking are not available.
	 */
